...
# Step 10 - Additional test
# Generate test HTML files, saved to working directory
#########

# page = hr.Element("Some content")
# page.append("Some more contenet")
# with open("test1.html", 'w') as outfile:
#     page.render(outfile)

# page = hr.Body("Some content")
# page.append("Some more contenet")
...
# page = hr.Html()
# body = hr.Body()
# body.append(hr.P("a very small paragraph"))
# body.append(hr.P("another small paragraph"))
# page.append(body)
...
# hd.append = ""
# page.append(body)
# with open("test4.html", 'w') as outfile:
#     page.render(outfile)
